...
<img src="/logo.png" alt="Comfort ERP logo">
```
...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/codeboxrcodehub/comforterpdocs-template
---
```
...
// .vitepress/config.js
 footer: {
   ...
   copyright: "Copyright © 2022-present Comfort ERP",
 },
```
...
- [Live Demo](https://Comfort ERP.vercel.app)
- [GitHub Repo](https://github.com/codeboxrcodehub/comforterpdocs)
